...
// ─── F1 Live Timing SignalR Core endpoints ──────────────────────────────────
const LIVETIMING_HOST         = 'https://livetiming.formula1.com';
const LIVETIMING_SIGNALR_CORE = `${LIVETIMING_HOST}/signalrcore`;
...
// Authenticated-only streams — require F1 TV Pro subscription token
// Data is zlib+base64 compressed; CarData.z contains per-car telemetry,
// Position.z contains XYZ circuit coordinates. (Ref: Fast-F1)
const LIVE_STREAMS_AUTH = {
  CAR_DATA: 'CarData.z',
  POSITION: 'Position.z',
};

// F1 TV authentication relay page URL (user opens this to log in)
const F1_AUTH_RELAY_URL = 'https://f1login.monkeysoft.nl';
